...
class StoneTransactionModel {
  ...
  factory StoneTransactionModel.fromJson(String source) =>
  ...
  bool operator ==(covariant StoneTransactionModel other) {
    ...
    return other.actionCode == actionCode &&
        other.aid == aid &&
        other.amount == amount &&
        other.arcq == arcq &&
        other.cardBrand == cardBrand &&
        other.cardHolderNumber == cardHolderNumber &&
        other.date == date &&
        other.entryMode == entryMode &&
        other.idFromBase == idFromBase &&
        other.isBuildResponse == isBuildResponse &&
        other.manufacture == manufacture &&
        other.result == result &&
        other.saleAffiliationKey == saleAffiliationKey &&
        other.serialNumber == serialNumber &&
        other.time == time &&
        other.transactionReference == transactionReference &&
        other.typeOfTransactionEnum == typeOfTransactionEnum &&
        other.errorMessage == errorMessage &&
        other.method == method &&
        other.transactionStatus == transactionStatus &&
        other.messageFromAuthorize == messageFromAuthorize &&
        other.message == message &&
        other.authorizationCode == authorizationCode &&
        other.actionResultMessage == actionResultMessage;
  }
  ...
  int get hashCode {
    return actionCode.hashCode ^
        ...
        arcq.hashCode ^
        cardBrand.hashCode ^
        cardHolderNumber.hashCode ^
        date.hashCode ^
        entryMode.hashCode ^
        idFromBase.hashCode ^
        isBuildResponse.hashCode ^
        manufacture.hashCode ^
        result.hashCode ^
        saleAffiliationKey.hashCode ^
        serialNumber.hashCode ^
        time.hashCode ^
        transactionReference.hashCode ^
        typeOfTransactionEnum.hashCode ^
        errorMessage.hashCode ^
        method.hashCode ^
        transactionStatus.hashCode ^
        messageFromAuthorize.hashCode ^
        message.hashCode ^
        authorizationCode.hashCode ^
        actionResultMessage.hashCode;
  }
}
